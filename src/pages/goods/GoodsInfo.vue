...
// 分析小球动画有Bug的原因： // 原因：就是因为 小球
入场动画的终点坐标，已经固定写死了！ // 解决问题的突破点：把小球 translate
时候的 横纵坐标，动态写活即可； // 如何实现： 如何把 横纵坐标 动态获取呢？ // +
先动态获取小球的横纵坐标 // + 再动态获取徽标的横纵坐标 // + 让 徽标的横纵坐标 -
小球的横纵坐标 等到的结果，就是小球要动态位移的距离；
